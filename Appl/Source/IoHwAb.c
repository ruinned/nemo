...
#include "MemMap.h"
  ...
  uint8 u8_spi_Lficdes_data[16] = {0,};
	...
	uint8 u8_spi_Rficsrc_data[16] = {0,};
...
uint16 IoHwAbConvert12bits_to_9bits(uint16 InputAdcValue)
{
return (InputAdcValue/8);
}


uint16 IoHwAbConvert10bits_to_9bits(uint16 InputAdcValue)
{
 ...
 *********************************************************************************************************************/
  ...
  *DutyCycle = 100-(uint8)(DowhsDutyCycle_1/400);
 ...
 *********************************************************************************************************************/
  ...
  *DutyCycle = (uint8)(DowhsDutyCycle_2/400);
 ...
 *********************************************************************************************************************/
  ...
  *DutyCycle = (uint8)(DowlsDutyCycle_1/400);
 ...
 *********************************************************************************************************************/
  ...
  *DutyCycle = (uint8)(DowlsDutyCycle_2/400);
 ...
 *********************************************************************************************************************/
  ...
  *DutyCycle = 100-(uint8)(DowlsDutyCycle_3/400);
...
// TestLfIrq = Dio_ReadChannel(DioConf_DioChannel_LFIC_IRQ);

// Dio_WriteChannel(DioConf_DioChannel_LF_IC_PWR_SHUTDOWN, TestLfIrq);


  if(TestRfReset==1)
  {
    //Dio_WriteChannel(DioConf_DioChannel_RFIC_NRES, RfResetVal);
  ...
  switch(TestRfIc)
  {
      u8_spi_Rficsrc_data[0] = 0x00;
      u8_spi_Rficsrc_data[1] = 0x00;
      u8_spi_Rficsrc_data[2] = 0x00;
      u8_spi_Rficsrc_data[3] = 0x00;
      u8_spi_Rficsrc_data[4] = 0x00;
      u8_spi_Rficsrc_data[5] = 0x00;
      u8_spi_Rficsrc_data[6] = 0x00;
      u8_spi_Rficsrc_data[7] = 0x00;
      
      u8_spi_Rficdes_data[0] = 0x00;
      u8_spi_Rficdes_data[1] = 0x00;
      u8_spi_Rficdes_data[2] = 0x00;
      u8_spi_Rficdes_data[3] = 0x00;
      u8_spi_Rficdes_data[4] = 0x00;
      u8_spi_Rficdes_data[5] = 0x00;
      u8_spi_Rficdes_data[6] = 0x00;
      u8_spi_Rficdes_data[7] = 0x00;

    case 0x04:  // Get Event
      u8_spi_Rficsrc_data[0] = 0x04;
      u8_spi_Rficsrc_data[1] = 0x00;
      u8_spi_Rficsrc_data[2] = 0x00;
      u8_spi_Rficsrc_data[3] = 0x00;
    ...
    case 0x08:  // Read SRAM/Register
      u8_spi_Rficsrc_data[0] = 0x08;
      u8_spi_Rficsrc_data[1] = 0x01;
      u8_spi_Rficsrc_data[2] = 0x03;
      u8_spi_Rficsrc_data[3] = 0x00;
      u8_spi_Rficsrc_data[4] = 0x00;
      u8_spi_Rficsrc_data[5] = 0x00;
      
      Spi_SetupEB(SpiConf_SpiChannel_RFIC_CH, u8_spi_Rficsrc_data, u8_spi_Rficdes_data, 8);
      u8_retTransmit = Spi_SyncTransmit(SpiConf_SpiSequence_RFIC_SEQ_DATA);

      u8_spi_Rficsrc_data[0] = 0x08;
      u8_spi_Rficsrc_data[1] = 0x01;
      u8_spi_Rficsrc_data[2] = 0x03;
      u8_spi_Rficsrc_data[3] = 0x01;
      u8_spi_Rficsrc_data[4] = 0x00;
      u8_spi_Rficsrc_data[5] = 0x00;
    ...
    case 0x09:  // Write EEPROM
      u8_spi_Rficsrc_data[0] = 0x09;
      u8_spi_Rficsrc_data[1] = 0x00;
      u8_spi_Rficsrc_data[2] = 0x09;
      u8_spi_Rficsrc_data[3] = 0x02;

      Spi_SetupEB(SpiConf_SpiChannel_RFIC_CH, u8_spi_Rficsrc_data, u8_spi_Rficdes_data, 8);
      u8_retTransmit = Spi_SyncTransmit(SpiConf_SpiSequence_RFIC_SEQ_DATA);
      break;

    case 0x0A:  // Read EEPROM
      u8_spi_Rficsrc_data[0] = 0x0A;
      u8_spi_Rficsrc_data[1] = 0x00;
      u8_spi_Rficsrc_data[2] = 0x09;
      u8_spi_Rficsrc_data[3] = 0x00;
      u8_spi_Rficsrc_data[4] = 0x00;
    ...
    case 0x13:  // Get Version Flash
      u8_spi_Rficsrc_data[0] = 0x13;
      u8_spi_Rficsrc_data[1] = 0x00;
      u8_spi_Rficsrc_data[2] = 0x00;
      u8_spi_Rficsrc_data[3] = 0x00;
      u8_spi_Rficsrc_data[4] = 0x00;
      ...
      Spi_SetupEB(SpiConf_SpiChannel_RFIC_CH, u8_spi_Rficsrc_data, u8_spi_Rficdes_data, 7);
      u8_retTransmit = Spi_SyncTransmit(SpiConf_SpiSequence_RFIC_SEQ_DATA);
      break;
