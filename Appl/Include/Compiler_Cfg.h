...
#define DCMADDON_CODE                /* code */
#define DCMADDON_VAR_INIT            /* initialized global/static variables */
#define DCMADDON_VAR_NOINIT          /* uninitialized global/static variables */
#define DCMADDON_APPL_DATA           /* variables/buffers outside of Dcm */
#define DCMADDON_CALLOUT_CODE        /* callback functions outside of Dcm but part of Dcm (callouts) */
...
#define RTE_VEC_ROMTEST_APPL_CODE
#define RTE_VEC_ROMTEST_APPL_VAR
#define RTE_VEC_ROMTEST_APPL_CONST
#define VEC_RomTest_VAR_NOINIT
#define VEC_RomTest_CONST
...
#define VPM_CODE
#define VPM_VAR_NOINIT
#define VPM_APPL_DATA
...
#define ISSM_APPL_VAR

#define ISSM_PBCFG
#define ISSM_VAR_PBCFG
