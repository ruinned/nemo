...
/* Sample Preprocessor directive for a newly configured OS-Application instance <OS_APPLICATION_NAME> */
  ...
  #if defined (DEM_START_SEC_OSAPPLICATION_UNTRUSTED_CORE0_VAR_NOINIT_UNSPECIFIED)
  # undef DEM_START_SEC_OSAPPLICATION_UNTRUSTED_CORE0_VAR_NOINIT_UNSPECIFIED                                                             
  # define START_SEC_VAR_NOINIT_UNSPECIFIED
  #endif
  
  #if defined (DEM_STOP_SEC_OSAPPLICATION_UNTRUSTED_CORE0_VAR_NOINIT_UNSPECIFIED)
  # undef DEM_STOP_SEC_OSAPPLICATION_UNTRUSTED_CORE0_VAR_NOINIT_UNSPECIFIED                                                              
  # define STOP_SEC_VAR_NOINIT_UNSPECIFIED
  #endif 
