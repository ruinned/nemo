 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_TP_Debug_PVT_PEPS_AntP1_X_Ctrl_Debug_PVT_PEPS_AntP1_X_Ctrl(P2VAR(Debug_PVT_PEPS_AntP1_X_Ctrl, AUTOMATIC, RTE_TP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_TP_Debug_PVT_PEPS_AntP1_Y_Ctrl_Debug_PVT_PEPS_AntP1_Y_Ctrl(P2VAR(Debug_PVT_PEPS_AntP1_Y_Ctrl, AUTOMATIC, RTE_TP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_TP_Debug_PVT_PEPS_AntPi_X_Ctrl_Debug_PVT_PEPS_AntPi_X_Ctrl(P2VAR(Debug_PVT_PEPS_AntPi_X_Ctrl, AUTOMATIC, RTE_TP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_TP_Debug_PVT_PEPS_AntPi_Y_Ctrl_Debug_PVT_PEPS_AntPi_Y_Ctrl(P2VAR(Debug_PVT_PEPS_AntPi_Y_Ctrl, AUTOMATIC, RTE_TP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_TP_Debug_PVT_PEPS_Logic_Ctrl_Debug_PVT_PEPS_Logic_Ctrl(P2VAR(Debug_PVT_PEPS_Logic_Ctrl, AUTOMATIC, RTE_TP_APPL_VAR) data); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_TP_TimeoutTxTelegram_P_CS(void); /* PRQA S 0850 */ /* MD_MSR_19.8 */
...
# define Rte_Call_TimeoutTxTelegram_P_CS Rte_Call_TP_TimeoutTxTelegram_P_CS
