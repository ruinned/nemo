...
#define CANNM_NUMBER_OF_CANNM_CHANNELS        3U
...
#define CanNmConf_CanNmTxPdu_NmAsr_CIOM_BB2_oBackbone2_a8a5afaa_Tx    0
#define CanNmConf_CanNmTxPdu_NmAsr_CIOM_Cab_oCabSubnet_2c086e5c_Tx    1
#define CanNmConf_CanNmTxPdu_NmAsr_CIOM_Sec_oSecuritySubnet_2d797674_Tx 2
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CanNmConf_CanNmRxPdu_Backbone2_CAN_f911ddd5_Rx                0
#define CanNmConf_CanNmRxPdu_CabSubnet_CAN_1a3a8edc_Rx                1
#define CanNmConf_CanNmRxPdu_SecuritySubnet_CAN_c9b1ce65_Rx           2
/**\} */
...
#define CANNM_EXPECTED_GENERATOR_COMPATIBILITY_VERSION  0x0802U
...
#define CANNM_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/EcuC/EcucGeneral/DummyStatement */
#endif
...
#define CANNM_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
...
#endif
#ifndef CANNM_PROCESSOR_MPC5746C
#define CANNM_PROCESSOR_MPC5746C
#endif
#ifndef CANNM_COMP_DIAB
#define CANNM_COMP_DIAB
#endif
#ifndef CANNM_GEN_GENERATOR_MSR
#define CANNM_GEN_GENERATOR_MSR
#endif
#ifndef CANNM_CPUTYPE_BITORDER_MSB2LSB
#define CANNM_CPUTYPE_BITORDER_MSB2LSB /* /MICROSAR/EcuC/EcucGeneral/BitOrder */
#endif
...
#define CANNM_COMCONTROLENABLEDOFCHANNELCONFIG                        STD_OFF  /**< Deactivateable: 'CanNm_ChannelConfig.ComControlEnabled' Reason: 'Com Control is disabled' */
...
#define CANNM_REPEATMSGINDENABLEDOFCHANNELCONFIG                      STD_OFF  /**< Deactivateable: 'CanNm_ChannelConfig.RepeatMsgIndEnabled' Reason: 'Repeat Msg Ind is disabled' */
...
#define CANNM_RXMESSAGEDATA_CBVIDXOFPBCHANNELCONFIG                   STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_CBVIdx' Reason: 'the optional indirection is deactivated because RxMessageData_CBVUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_RXMESSAGEDATA_CBVUSEDOFPBCHANNELCONFIG                  STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.RxMessageData_CBVUsed' Reason: 'the optional indirection is deactivated because RxMessageData_CBVUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CANNM_TXMESSAGEDATA_CBVIDXOFPBCHANNELCONFIG                   STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_CBVIdx' Reason: 'the optional indirection is deactivated because TxMessageData_CBVUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
#define CANNM_TXMESSAGEDATA_CBVUSEDOFPBCHANNELCONFIG                  STD_OFF  /**< Deactivateable: 'CanNm_PbChannelConfig.TxMessageData_CBVUsed' Reason: 'the optional indirection is deactivated because TxMessageData_CBVUsedOfPbChannelConfig is always 'FALSE' and the target of the indirection is of the Configuration Class 'PRE_COMPILE'.' */
...
#define CanNm_GetSizeOfSysToNmChIndOfPCConfig()                       10U  /**< the number of accomplishable value elements in CanNm_SysToNmChInd */
#define CanNm_GetSizeOfTxMessageDataOfPCConfig()                      3U  /**< the number of accomplishable value elements in CanNm_TxMessageData */
...
{
  CanNm_CommStateType CN_Backbone2_78967e2c[1];
  CanNm_CommStateType CN_CabSubnet_9ea693f1[1];
  CanNm_CommStateType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_CoordReadyToSleepStateType CN_Backbone2_78967e2c[1];
  CanNm_CoordReadyToSleepStateType CN_CabSubnet_9ea693f1[1];
  CanNm_CoordReadyToSleepStateType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_MsgConfirmationFlagType CN_Backbone2_78967e2c[1];
  CanNm_MsgConfirmationFlagType CN_CabSubnet_9ea693f1[1];
  CanNm_MsgConfirmationFlagType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_MsgIndicationFlagType CN_Backbone2_78967e2c[1];
  CanNm_MsgIndicationFlagType CN_CabSubnet_9ea693f1[1];
  CanNm_MsgIndicationFlagType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_MsgTimeoutTimerType CN_Backbone2_78967e2c[1];
  CanNm_MsgTimeoutTimerType CN_CabSubnet_9ea693f1[1];
  CanNm_MsgTimeoutTimerType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_MsgTimerType CN_Backbone2_78967e2c[1];
  CanNm_MsgTimerType CN_CabSubnet_9ea693f1[1];
  CanNm_MsgTimerType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_NetworkRestartFlagType CN_Backbone2_78967e2c[1];
  CanNm_NetworkRestartFlagType CN_CabSubnet_9ea693f1[1];
  CanNm_NetworkRestartFlagType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_RepeatMsgTimerType CN_Backbone2_78967e2c[1];
  CanNm_RepeatMsgTimerType CN_CabSubnet_9ea693f1[1];
  CanNm_RepeatMsgTimerType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_TimeoutTimerType CN_Backbone2_78967e2c[1];
  CanNm_TimeoutTimerType CN_CabSubnet_9ea693f1[1];
  CanNm_TimeoutTimerType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_TxControlStateType CN_Backbone2_78967e2c[1];
  CanNm_TxControlStateType CN_CabSubnet_9ea693f1[1];
  CanNm_TxControlStateType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_TxControlStateRequestType CN_Backbone2_78967e2c[1];
  CanNm_TxControlStateRequestType CN_CabSubnet_9ea693f1[1];
  CanNm_TxControlStateRequestType CN_SecuritySubnet_e7a0ee54[1];
...
{
  CanNm_WaitBusSleepTimerType CN_Backbone2_78967e2c[1];
  CanNm_WaitBusSleepTimerType CN_CabSubnet_9ea693f1[1];
  CanNm_WaitBusSleepTimerType CN_SecuritySubnet_e7a0ee54[1];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_CoordReadyToSleepStateType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_MsgConfirmationFlagType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_MsgIndicationFlagType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_MsgTimeoutTimerType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_NetworkRestartFlagType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_RepeatMsgTimerType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_TxControlStateType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_TxControlStateRequestType raw[3];
...
{  /* PRQA S 0750 */  /* MD_CSL_18.4 */
  CanNm_WaitBusSleepTimerType raw[3];
...
/*lint -restore */
extern CONST(CanNm_ChannelConfigType, CANNM_CONST) CanNm_ChannelConfig[3];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(CanNm_SysToNmChIndType, CANNM_CONST) CanNm_SysToNmChInd[10];
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(CanNm_RxMessageDataType, CANNM_VAR_NOINIT) CanNm_RxMessageData[3];
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern VAR(CanNm_TxMessageDataType, CANNM_VAR_NOINIT) CanNm_TxMessageData[3];
#define CANNM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
