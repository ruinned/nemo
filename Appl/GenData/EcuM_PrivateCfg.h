 ...
 *   Generation Time: 2018-11-22 19:47:34
...
#define EcuM_GetMaxWakeupSourceCountOfPCConfig()                      15U  /**< Max Wakeup source count. */
...
#define EcuM_GetSizeOfWakeupSourceListOfPCConfig()                    15U  /**< the number of accomplishable value elements in EcuM_WakeupSourceList */
...
**********************************************************************************************************************/
/** 
  \defgroup  EcuMPBGetRootDataMacros  EcuM Get Root Data Macros (POST_BUILD)
  \brief  These are used to get data pointers of root data.
  \{
*/ 
#define EcuM_GetEcuM_CRCHash_LowerOfPBConfig()                        EcuM_ConfigDataPtr->EcuM_CRCHash_LowerOfPBConfig
#define EcuM_GetEcuM_CRCHash_UpperOfPBConfig()                        EcuM_ConfigDataPtr->EcuM_CRCHash_UpperOfPBConfig
#define EcuM_GetFinalMagicNumberOfPBConfig()                          EcuM_ConfigDataPtr->FinalMagicNumberOfPBConfig
#define EcuM_GetGeneratorCompatibilityVersionOfPBConfig()             EcuM_ConfigDataPtr->GeneratorCompatibilityVersionOfPBConfig
#define EcuM_GetInitDataHashCodeOfPBConfig()                          EcuM_ConfigDataPtr->InitDataHashCodeOfPBConfig
/** 
  \}
*/ 

/** 
  \defgroup  EcuMPBGetDeduplicatedDataMacros  EcuM Get Deduplicated Data Macros (POST_BUILD)
  \brief  These macros can be used to read deduplicated data elements.
  \{
*/ 
#define EcuM_GetEcuM_CRCHash_Lower()                                  EcuM_GetEcuM_CRCHash_LowerOfPBConfig()
#define EcuM_GetEcuM_CRCHash_Upper()                                  EcuM_GetEcuM_CRCHash_UpperOfPBConfig()
#define EcuM_GetFinalMagicNumber()                                    EcuM_GetFinalMagicNumberOfPBConfig()
#define EcuM_GetGeneratorCompatibilityVersion()                       EcuM_GetGeneratorCompatibilityVersionOfPBConfig()
#define EcuM_GetInitDataHashCode()                                    EcuM_GetInitDataHashCodeOfPBConfig()
/** 
  \}
*/ 

/** 
  \defgroup  EcuMPBHasMacros  EcuM Has Macros (POST_BUILD)
  \brief  These macros can be used to detect at runtime a deactivated piece of information. TRUE in the CONFIGURATION_VARIANT PRE-COMPILE, TRUE or FALSE in the CONFIGURATION_VARIANT POST-BUILD.
  \{
*/ 
#define EcuM_HasEcuM_CRCHash_Lower()                                  (TRUE != FALSE)
#define EcuM_HasEcuM_CRCHash_Upper()                                  (TRUE != FALSE)
#define EcuM_HasFinalMagicNumber()                                    (TRUE != FALSE)
#define EcuM_HasGeneratorCompatibilityVersion()                       (TRUE != FALSE)
#define EcuM_HasInitDataHashCode()                                    (TRUE != FALSE)
#define EcuM_HasPBConfig()                                            (TRUE != FALSE)
#define EcuM_HasEcuM_CRCHash_LowerOfPBConfig()                        (TRUE != FALSE)
#define EcuM_HasEcuM_CRCHash_UpperOfPBConfig()                        (TRUE != FALSE)
#define EcuM_HasFinalMagicNumberOfPBConfig()                          (TRUE != FALSE)
#define EcuM_HasGeneratorCompatibilityVersionOfPBConfig()             (TRUE != FALSE)
#define EcuM_HasInitDataHashCodeOfPBConfig()                          (TRUE != FALSE)
/** 
  \}
*/ 
...
extern P2CONST(EcuM_PbConfigType, ECUM_VAR_NOINIT, ECUM_PBCFG) EcuM_ConfigDataPtr;
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
extern CONST(EcuM_WakeupSourceListType, ECUM_CONST) EcuM_WakeupSourceList[15];
#define ECUM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_19.1 */
/*lint -restore */
