...
# define DCM_LCFG_MAJOR_VERSION                                                 9u
...
/*! Depends on the size of the bigger from the tables Dcm_CfgDidMgrOpInfoIoControl and Dcm_CfgDidMgrOpInfoScaling */
...
/*! Depends on the size of Dcm_CfgDidMgrOpInfoScaling table */
...
struct DCM_DIDMGRDIDINFOTYPE_TAG
{
  ...
  Dcm_CfgDidMgrOptimizedDidLengthType  MaxLength; /* contains the maximum (on DIDs with dynamic length) or the complete length on static DIDs */
...
struct DCM_CFGDIDMGRSIGNALOPCLASSINFOTYPE_TAG
{
  ...
  Dcm_CfgDidMgrSignalLengthType  MinLength;
  Dcm_CfgDidMgrSignalLengthType  MaxLength;
...
struct DCM_CFGDIDMGROPINFOCOMBINEDTYPE_TAG
{
  ...
  Dcm_CfgDidMgrCombinedOpRefType OpRefRoE;
};
...
{
  Dcm_DidMgrRoEEventIdType EventId;
};
...
struct DCM_CFGMEMMGRMEMMAPINFOTYPE_TAG
{
  ...
  Dcm_CfgMemMgrStateRefType    ExecCondRefs[DCM_MEMMGR_NUM_MEMORY_OPERATIONS_CONST]; /*!< Reference to the Dcm_CfgStatePreconditions[] entry */
};
 ...
 *  \return        DCM_E_OK              Job processing finished
 ...
 *  \pre           -
***********************************************************************************************************************/
FUNC(Std_ReturnType, DCM_CALLOUT_CODE) Dcm_DiagnosticService_0x01(Dcm_OpStatusType opStatus, Dcm_MsgContextPtrType pMsgContext);
/***********************************************************************************************************************
...
extern CONST(Dcm_NetConnRefMemType, DCM_CONST) Dcm_CfgNetTxPduInfo[4];
...
/*! RxPduId map */
extern CONST(Dcm_CfgNetRxPduInfoType, DCM_CONST) Dcm_CfgNetRxPduInfo[5];
/*! DCM connection descriptor */
extern CONST(Dcm_CfgNetConnectionInfoType, DCM_CONST) Dcm_CfgNetConnectionInfo[3];
