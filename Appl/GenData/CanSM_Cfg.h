 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: CanSM_Cfg.h
 *   Generation Time: 2018-11-22 20:14:48
...
#define CANSM_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/EcuC/EcucGeneral/DummyStatement */
#endif
...
#endif
#ifndef CANSM_PROCESSOR_MPC5746C
#define CANSM_PROCESSOR_MPC5746C
#endif
#ifndef CANSM_COMP_DIAB
#define CANSM_COMP_DIAB
#endif
#ifndef CANSM_GEN_GENERATOR_MSR
#define CANSM_GEN_GENERATOR_MSR
#endif
#ifndef CANSM_CPUTYPE_BITORDER_MSB2LSB
#define CANSM_CPUTYPE_BITORDER_MSB2LSB /* /MICROSAR/EcuC/EcucGeneral/BitOrder */
#endif
...
#define CanSM_GetControllerIdOfChannelConfig(Index)                   (CanSM_GetChannelConfigOfPCConfig()[(Index)].ControllerIdOfChannelConfig)
...
#define CanSM_GetDemEventId_ModeRequest_OfChannelConfig(Index)        (CanSM_GetChannelConfigOfPCConfig()[(Index)].DemEventId_ModeRequest_OfChannelConfig)
...
#define CanSM_IsProdErrorDetect_ModeRequest_OfChannelConfig(Index)    (((TRUE)) != FALSE)
...
#define CanSM_HasProdErrorDetect_ModeRequest_OfChannelConfig()        (TRUE != FALSE)
...
#define CANSM_PRODERRORDETECT_MODEREQUEST_OFCHANNELCONFIG             STD_ON
...
#define CANSM_ISDEF_DEMEVENTID_MODEREQUEST_OFCHANNELCONFIG            STD_OFF
...
#define CANSM_ISDEF_PRODERRORDETECT_MODEREQUEST_OFCHANNELCONFIG       STD_ON
...
#define CANSM_EQ2_DEMEVENTID_MODEREQUEST_OFCHANNELCONFIG              
...
#define CANSM_EQ2_PRODERRORDETECT_MODEREQUEST_OFCHANNELCONFIG         TRUE
...
/**   \brief  value based type definition for CanSM_ProdErrorDetect_ModeRequest_OfChannelConfig */
typedef boolean CanSM_ProdErrorDetect_ModeRequest_OfChannelConfigType;
...
{
  CanSM_ControllerIdOfChannelConfigType ControllerIdOfChannelConfig;
  CanSM_NetworkHandleOfChannelConfigType NetworkHandleOfChannelConfig;
  Dem_EventIdType DemEventId_BusOff_OfChannelConfig;
  Dem_EventIdType DemEventId_ModeRequest_OfChannelConfig;
...
typedef P2FUNC(void, CANSM_APPL_CODE, CanSM_BusOffBeginIndicationFctPtrType) ( NetworkHandleType  NetworkHandle, P2VAR(uint8, AUTOMATIC, CANSM_APPL_VAR) OnlineDelayCyclesPtr ); /* PRQA S 0850 */  /* MD_MSR_19.8  */
...
extern FUNC(void, CANSM_APPL_CODE) J1939Nm_GetBusOffDelay( NetworkHandleType  NetworkHandle, P2VAR(uint8, AUTOMATIC, CANSM_APPL_VAR) OnlineDelayCyclesPtr );
...
typedef P2FUNC(void, CANSM_APPL_CODE, CanSM_BusOffEndIndicationFctPtrType) ( NetworkHandleType  NetworkHandle ); /* PRQA S 0850 */  /* MD_MSR_19.8  */
...
extern FUNC(void, CANSM_APPL_CODE) J1939Nm_BusOffEnd( NetworkHandleType  NetworkHandle );
