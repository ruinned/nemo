...
#define MCL_PBCFG_SW_PATCH_VERSION_C              0
...
{
{
    ...
    (DMA_HALT_ON_ERROR_DIS_U32) |    /** @violates @ref Mcl_PB_PC_Cfg_c_REF_11 Boolean operation whose results are invariant shall not be permitted */
    (DMA_ROUND_ROBIN_GROUP_ARB_DIS_U32) |    (DMA_ROUND_ROBIN_ARB_DIS_U32) |
