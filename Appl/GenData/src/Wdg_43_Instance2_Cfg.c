...
*
* @section Wdg_43_Instance2_Cfg_c_REF_1
...
*
* @section Wdg_43_Instance2_Cfg_c_REF_2
*          Violates MISRA 2004 Required Rule 19.15, Precautions shall be taken in order to
*          prevent the contents of a header file being included twice. All header files are
*          protected against multiple inclusions.
*
* @section Wdg_43_Instance2_Cfg_c_REF_3
*          Violates MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked to ensure
*          that 31 character significance and case sensitivity are supported for external identifiers.
*          The defines are validated.
*
* @section Wdg_43_Instance2_Cfg_c_REF_4
...
*
* @section Wdg_43_Instance2_Cfg_c_REF_5
...
/** @violates @ref Wdg_43_Instance2_Cfg_c_REF_3 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure
 *  that 31 character significance and case sensitivity are supported for external identifiers. */
...
/* Check if current file and Wdg header file are of the same vendor */
    ...
    #error "Wdg_43_Instance2_Cfg.c and Wdg_Channel.h have different vendor ids"
#endif
...
/* Check if current file and Wdg header file are of the same Autosar version */
     ...
     #error "AutoSar Version Numbers of Wdg_43_Instance2_Cfg.c and Wdg_Channel.h are different"
#endif
/* Check if current file and Wdg header file are of the same Software version */
    ...
    #error "Software Version Numbers of Wdg_43_Instance2_Cfg.c and Wdg_Channel.h are different"
    #endif
    ...
    /* Check if current file and Reg_eSys_Swt header file are of the same vendor */
        ...
        #error "Wdg_43_Instance2_Cfg.c and Reg_eSys_Swt_defines.h have different vendor ids"
    #endif
    ...
    /* Check if current file and Reg_eSys_Swt header file are of the same Autosar version */
        ...
        #error "AutoSar Version Numbers of Wdg_43_Instance2_Cfg.c and Reg_eSys_Swt_defines.h are different"
    #endif
    ...
    /* Check if current file and Reg_eSys_Swt header file are of the same Software version */
        ...
        #error "Software Version Numbers of Wdg_43_Instance2_Cfg.c and Reg_eSys_Swt_defines.h are different"
    #endif
#endif
...
#endif /* #if WDG_INSTANCE_43_Instance2 == STD_ON*/
#ifdef __cplusplus
}
#endif
