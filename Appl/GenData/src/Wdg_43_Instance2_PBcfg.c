...
*
* @section Wdg_43_Instance2_PBcfg_c_REF_1
*          Violates MISRA 2004 Required Rule 19.15, Precautions shall be taken in order to
*          prevent the contents of a header file being included twice. All header files are
*          protected against multiple inclusions.
*
* @section Wdg_43_Instance2_PBcfg_c_REF_2
*          Violates MISRA 2004 Required Rule 1.4, The compiler/linker shall be checked to ensure
*          that 31 character significance and case sensitivity are supported for external identifiers.
*          The defines are validated.
*
* @section Wdg_43_Instance2_PBcfg_c_REF_3
...
*
* @section Wdg_43_Instance2_PBcfg_c_REF_4
...
*
* @section Wdg_43_Instance2_PBcfg_c_REF_5
...
/** @violates @ref Wdg_43_Instance2_PBcfg_c_REF_2 MISRA 2004 Rule 1.4, The compiler/linker shall be checked to ensure
*  that 31 character significance and case sensitivity are supported for external identifiers. */
 ...
 *                                      FILE VERSION CHECKS
 ==================================================================================================*/
  ...
  /* Check if current file and Wdg header file are of the same vendor */
     ...
     #error "Wdg_43_Instance2_PBcfg.c and Wdg_Channel.h have different vendor ids"
 #endif
 ...
 /* Check if source file and Wdg header file are of the same Autosar version */
     ...
     #error "AutoSar Version Numbers of Wdg_43_Instance2_PBcfg.c and Wdg_Channel.h are different"
 #endif
 /* Check if source file and Wdg header file are of the same Software version */
     ...
     #error "Software Version Numbers of Wdg_43_Instance2_PBcfg.c and Wdg_Channel.h are different"
 #endif
     ...
     /* Check if source file and Reg_eSys_Swt_defines header file are of the same vendor */
         ...
         #error "Wdg_43_Instance2_PBcfg.c and Reg_eSys_Swt_defines.h have different vendor ids"
     #endif
     ...
     /* Check if source file and Reg_eSys_Swt_defines header file are of the same Autosar version */
         ...
         #error "AutoSar Version Numbers of Wdg_43_Instance2_PBcfg.c and Reg_eSys_Swt_defines.h are different"
     #endif
     ...
     /* Check if source file and Reg_eSys_Swt_defines header file are of the same Software version */
         ...
         #error "Software Version Numbers of Wdg_43_Instance2_PBcfg.c and Reg_eSys_Swt_defines.h are different"
     #endif
 #endif
 ...
 * @violates @ref Wdg_43_Instance2_PBcfg_c_REF_1 MISRA 2004 Required Rule 19.15, precautions to prevent the contents
 *                of a header file being included twice
 * @violates @ref Wdg_43_Instance2_PBcfg_c_REF_4 MISRA 2004 Required Rule 19.1, only preprocessor statements
 ...
 * @violates @ref Wdg_43_Instance2_PBcfg_c_REF_5 MISRA 2004 Required Rule 8.8, An external object or function shall be declared in
 * one and only one file. This is an callback function from a macrofile
 */
...
/** 
 * @violates @ref Wdg_43_Instance2_PBcfg_c_REF_3  MISRA 2004 Required Rule 8.10, All declarations and definitions of objects or
 * functions at file scope shall have internal linkage unless external linkage is required.
 */
CONST(Wdg_Swt_ConfigType, WDG_CONST) Wdg_Swt_OffModeSettings_2=
{
