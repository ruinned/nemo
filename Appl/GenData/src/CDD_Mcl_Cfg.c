...
#define MCL_CFG_SW_PATCH_VERSION_C              0
...

{
    ...
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_BUS
    ...
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_DESCRIPTOR
    
    },
    /** MCL_DMA_E_ECC error code */
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_ECC
    
    },
    /** MCL_DMA_E_PRIORITY error code */ 
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_PRIORITY
    ...
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_UNRECOGNIZED
    ...
    {
            (uint32)STD_ON,
                (uint16)DemConf_DemEventParameter_AutoCreatedDemEvent_MCL_E_DMA_INCONSISTENCY
