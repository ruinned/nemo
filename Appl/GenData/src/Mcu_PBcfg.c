...
*   SW Version           : 1.0.0
*   Build Version        : MPC574XG_MCAL_1_0_0_RTM_HF1_ASR_REL_4_2_REV_0002_20171002
*
...
/**
    ...
    ARConfVariant
    SWVersion 1.0.0
    BuildVersion MPC574XG_MCAL_1_0_0_RTM_HF1_ASR_REL_4_2_REV_0002_20171002
...
static CONST( Mcu_MC_CGM_RegisterConfigType, MCU_CONST) MC_CGM_aAuxClockConfigPB0_0[12] = 
{
    ...
    {
        MC_CGM_AC6_SC_ADDR32,
        MC_CGM_AUXCLK6_U32(MC_CGM_AUXCLK6_SOURCE_PLL0_PHI0_U32)
    }
    ...
    ,
    {
        ...
        (                        
            ...
            MC_CGM_AUXCLK6_DIV0_U32((uint32)1U)
        )
    }
    ...
    /* Auxiliary Clock9 Source Selection. */
    {
        ...
        MC_CGM_AUXCLK9_U32(MC_CGM_AUXCLK9_SOURCE_FS80_U32)
    }
...
static CONST( Mcu_FXOSC_ConfigType, MCU_CONST) Mcu_FXOSC_ClockConfigPB0_0 = 
{
    ...
    FXOSC_CTL_VALUE_U32(
        ...
        FXOSC_CTL_EOCV_VALUE_U32( (uint32)0U ) |
...
*/
/** @violates @ref Mcu_PBcfg_c_REF_3 MISRA 2004 Required Rule 1.4, 31 characters limit.*/
static CONST( Mcu_PLLDIG_RegisterConfigType, MCU_CONST) Mcu_PLLDIG_aRegistersConfigPB0_0[5U] = 
{
    ...
    },
    {
        ...
        MCU_PLLDIG_PLL0DV_U32(
            MCU_PLLDIG_PLL0DV_RFDPHI1_U32( (uint32)2U ) | 
            MCU_PLLDIG_PLL0DV_RFDPHI_U32( (uint32)1U ) |
            MCU_PLLDIG_PLL0DV_PREDIV_U32( (uint32)4U ) |
            MCU_PLLDIG_PLL0DV_MFD_U32( (uint32)64U )
        )
    },
    {
        PLLDIG_PLL0FM_ADDR32,
        MCU_PLLDIG_PLL0FM_U32(
            MCU_PLLDIG_PLL0FM_SSCGBYP_DIS_U32 |
...
static CONST( Mcu_MC_RGM_ConfigType, MCU_CONST) MC_RGM_ConfigPB0 =
{
    ...
    (
        ...
        (MC_RGM_LVD_IO_A_HI_EVENT_RESET_U32) |
