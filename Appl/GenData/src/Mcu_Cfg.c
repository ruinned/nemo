...
CONST( Mcu_DemConfigType, MCU_CONST) Mcu_Dem_Config = 
{
    ...
    {(uint32)STD_ON, DemConf_DemEventParameter_AutoCreatedDemEvent_MCU_E_TIMEOUT_FAILURE},

    /* DEM error reporting MCU_E_INVALIDMODE_CONFIG */
    {(uint32)STD_ON, DemConf_DemEventParameter_AutoCreatedDemEvent_MCU_E_INVALIDMODE_CONFIG},

    /* DEM error reporting MCU_E_SSCM_CER_FAILURE */
    {(uint32)STD_ON, DemConf_DemEventParameter_AutoCreatedDemEvent_MCU_E_SSCM_CER_FAILURE}
