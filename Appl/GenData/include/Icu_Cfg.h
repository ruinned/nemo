...
*/
#define ICU_WKUP_PULLUP_MASK_U32            ((uint32)0x00000000u)
...
#define IcuChannel_RFIC_IRQ                     (IcuConf_IcuChannel_IcuChannel_RFIC_IRQ)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_RFIC_IRQ  ((Icu_ChannelType)2U) 
#define IcuChannel_LFIC_IRQ                     (IcuConf_IcuChannel_IcuChannel_LFIC_IRQ)
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define IcuConf_IcuChannel_IcuChannel_LFIC_IRQ  ((Icu_ChannelType)1U) 
...
/* @violates @ref Icu_Cfg_h_REF_3 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define SIGNAL_MEASUREMENT_USES_SAIC_MODE            (STD_ON)
...
*   @{
*/
#define ICU_WKPU_CH_27_ISR_USED 
#define ICU_WKPU_CH_28_ISR_USED 
