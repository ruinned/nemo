...
#define ADC_CWSELR5_AVAILABLE  (STD_ON)
#define ADC_CWSELR6_AVAILABLE  (STD_ON)
#define ADC_CWSELR7_AVAILABLE  (STD_ON)
...
*/
#define ADC_MAX_CTU_EVTCFGREGS             (64U)

/**
* @brief          Adc 10 bit resolution available.
*/
#define ADC_UNIT_10_BITS_AVAILABLE         (STD_ON)
 ...
 */
#define ADC_MAX_HW_UNITS_CFG                      (2U)
...
*/
#define ADC_MAX_CHANNEL_PER_HW_UNIT         17U
...
#define AdcChannel_PB9                       0
#define AdcChannel_PD2                       0
#define AdcChannel_PB8                       1
#define AdcChannel_PD3                       1
#define AdcChannel_PB10                       2
#define AdcChannel_PD4                       2
#define AdcChannel_PF0                       3
#define AdcChannel_PD5                       3
#define AdcChannel_PF1                       4
#define AdcChannel_PD7                       4
#define AdcChannel_PF2                       5
#define AdcChannel_PD8                       5
#define AdcChannel_PF3                       6
#define AdcChannel_PB4                       6
#define AdcChannel_PF4                       7
#define AdcChannel_PB5                       7
#define AdcChannel_PF5                       8
#define AdcChannel_PB6                       8
#define AdcChannel_PF6                       9
#define AdcChannel_PD10                       9
#define AdcChannel_PF7                       10
#define AdcChannel_PA7                       10
#define AdcChannel_PJ3                       11
#define AdcChannel_PA8                       11
#define AdcChannel_PJ1                       12
#define AdcChannel_PA9                       12
#define AdcChannel_PI14                       13
#define AdcChannel_PG0                       13
#define AdcChannel_PB12                       14
#define AdcChannel_PF15                       14
#define AdcChannel_PB13                       15
#define AdcChannel_PF14                       15
#define AdcChannel_PE13                       16
...
#define AdcGroup_Adc0                       0
#define AdcGroup_Adc1                       1
...
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define AdcConf_AdcGroup_AdcGroup_Adc0                       0
/** @violates @ref Adc_CfgDefines_h_REF_2 MISRA-C:2004 Rule 1.4: Identifier clash.*/
#define AdcConf_AdcGroup_AdcGroup_Adc1                       1
...
*/
#define ADC_MAX_CHANNEL_SEGMENTS_U8     (9U)


/** 
* @brief           Number of BCTU_SFTRG register.
*/
#define BCTU_NUMB_SFTRG_REG             (2U)

/** 
* @brief           Number of BCTU_LISTCHR register.
*/
#define BCTU_NUMB_LISTCHR_REG           (16U)

/** 
* @brief           Number of BCTU_TRGCFG register.
*/
#define BCTU_NUMB_TRGCFG_REG            (64U)
