 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: Dem_Cfg.h
 *   Generation Time: 2018-11-27 18:44:38
...
#define DEM_CFG_SW_MAJOR_VERSION                                      14U
#define DEM_CFG_SW_MINOR_VERSION                                      6U
#define DEM_CFG_SW_PATCH_VERSION                                      0U

/* Generator Version Information */
#define DEM_CFG_GEN_MAJOR_VERSION                                     12
#define DEM_CFG_GEN_MINOR_VERSION                                     5
#define DEM_CFG_GEN_PATCH_VERSION                                     0
#define DEM_CFG_GEN_COMPATIBILITY_VERSION                             95622UL

/* Module Implementation Variant */
#define DEM_CFG_VARIANT_PRECOMPILE                                    STD_OFF      /* STD_ON: PreCompile phase is the latest point to change the configuration. STD_OFF: PostBuild phase is the latest point. */
#define DEM_CFG_VARIANT_POSTBUILD_LOADABLE                            STD_ON      /* STD_ON: PostBuild phase is the latest point to change the configuration. STD_OFF: PreCompile phase is the latest point. */
...
/* Generator Internal Version                                         12.05.00 (Cfg5.16.x/Cfg5.17.x compatible, Release AR4-20), Revision: 95622, Variant: VolvoAB (Vector) */
...
#define DEM_CFG_AGING_RETAIN_MEMORY_ENTRY                                  STD_ON       /* Vector extension - /Dem/DemGeneral/DemAgingRetainEnvironmentalData */ 
...
#define DEM_CFG_BSW_API_3_XX_XX                                            STD_ON       /* Vector extension - /Dem/DemGeneral/DemBswApiVersion == DEM_BSW_API_3_XX_XX */ 
...
#define DEM_CFG_BSW_API_4_XX_XX                                            STD_OFF      /* Vector extension - /Dem/DemGeneral/DemBswApiVersion == DEM_BSW_API_4_XX_XX */ 
...
#define DEM_CFG_PROCESS_OCCTR_CONFIRMED                                    STD_ON       /* Autodetected - via /Dem/DemGeneral/DemOccurrenceCounterProcessing == DEM_PROCESS_OCCCTR_CDTC */ 
#define DEM_CFG_PROCESS_OCCTR_TESTFAILED                                   STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemOccurrenceCounterProcessing == DEM_PROCESS_OCCCTR_TF */ 
...
#define DEM_CFG_PROCESS_WIR_ALL_DTC                                        STD_ON       /* Autodetected - via /Dem/DemGeneral/DemWarningIndicatorRequestedProcessing == DEM_PROCESS_WIR_ALL_DTC */ 
#define DEM_CFG_PROCESS_WIR_STOREDONLY                                     STD_OFF      /* Autodetected - via /Dem/DemGeneral/DemWarningIndicatorRequestedProcessing == DEM_PROCESS_WIR_STOREDONLY */ 
...
#define DEM_CFG_SUPPORT_CYCLE_IGNITION                                     STD_ON       /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 1 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_CYCLE_OBD_DCY                                      STD_OFF      /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 0 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
#define DEM_CFG_SUPPORT_CYCLE_OTHER                                        STD_OFF      /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 0 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
#define DEM_CFG_SUPPORT_CYCLE_POWER                                        STD_OFF      /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 0 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
#define DEM_CFG_SUPPORT_CYCLE_TIME                                         STD_OFF      /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 0 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
#define DEM_CFG_SUPPORT_CYCLE_WARMUP                                       STD_OFF      /* Autodetected - STD_ON: cycle type is or may be (later via PostBuildLoadable) referenced by any *CycleRef or the /Dem/DemGeneral/DemRestartCycleOnInitRef parameter, STD_OFF: cycle type is not and will never be referenced. The '*CycleRef' params are (here 0 refs): /Dem/DemConfigSet/DemEventParameter/DemEventClass/DemAgingCycleRef, ~/DemOperationCycleRef, ~/DemIndicatorAttribute/DemIndicatorFailureCycleRef and ~/DemIndicatorAttribute/DemIndicatorHealingCycleRef. */ 
...
#define DEM_CFG_SUPPORT_MIL_GROUP                                          STD_OFF      /* Vector extension - STD_ON: [PostBuild-Loadable or -Selectable] any /Dem/DemGeneral/DemMILGroup container exists, STD_OFF: else. */ 
...
#define DEM_CFG_SUPPORT_OPCYCLE_STORAGE                                    STD_ON       /* /Dem/DemGeneral/DemOperationCycleStatusStorage */ 
...
#define DEM_ATOMIC_BIT_ACCESS_IN_BITFIELD STD_ON /* /MICROSAR/EcuC/EcucGeneral/AtomicBitAccessInBitfield */
#endif
#ifndef DEM_ATOMIC_VARIABLE_ACCESS
#define DEM_ATOMIC_VARIABLE_ACCESS 32U /* /MICROSAR/EcuC/EcucGeneral/AtomicVariableAccess */
#endif
#ifndef DEM_PROCESSOR_MPC5746C
#define DEM_PROCESSOR_MPC5746C
#endif
#ifndef DEM_COMP_DIAB
#define DEM_COMP_DIAB
#endif
#ifndef DEM_GEN_GENERATOR_MSR
#define DEM_GEN_GENERATOR_MSR
#endif
#ifndef DEM_CPUTYPE_BITORDER_MSB2LSB
#define DEM_CPUTYPE_BITORDER_MSB2LSB /* /MICROSAR/EcuC/EcucGeneral/BitOrder */
#endif
...
#define DEM_CONFIGURATION_VARIANT DEM_CONFIGURATION_VARIANT_POSTBUILD_LOADABLE
#endif
...
#define DEM_CFG_DIAGNOSTIC_OEM                                        DEM_OEM_VOLVOAB
...
#endif  /* DEM_CFG_H */
/**********************************************************************************************************************
  END OF FILE: Dem_Cfg.h     [VolvoAB (Vector), VARIANT-POSTBUILD-LOADABLE, 12.05.00.95622]
**********************************************************************************************************************/
