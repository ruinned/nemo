 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DemMaster_OsApplication_Untrusted_Core0_Type.h
 *        Config:  SCIM_BP.dpa
 *   ECU-Project:  CIOM
 *
 ...
 *
 *   Description:  Application types header file for SW-C <DemMaster_OsApplication_Untrusted_Core0>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DEMMASTER_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H
# define _RTE_DEMMASTER_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H
...
#endif /* _RTE_DEMMASTER_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H */
