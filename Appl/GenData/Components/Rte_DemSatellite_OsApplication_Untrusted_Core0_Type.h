 ...
 *  FILE DESCRIPTION
 *  -------------------------------------------------------------------------------------------------------------------
 *          File:  Rte_DemSatellite_OsApplication_Untrusted_Core0_Type.h
 *        Config:  SCIM_BP.dpa
 *   ECU-Project:  CIOM
 *
 ...
 *
 *   Description:  Application types header file for SW-C <DemSatellite_OsApplication_Untrusted_Core0>
 *********************************************************************************************************************/

/* double include prevention */
#ifndef _RTE_DEMSATELLITE_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H
# define _RTE_DEMSATELLITE_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H
...
#endif /* _RTE_DEMSATELLITE_OSAPPLICATION_UNTRUSTED_CORE0_TYPE_H */
