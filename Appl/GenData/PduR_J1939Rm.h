 ...
 *           The PDU Router evaluates the J1939Rm I-PDU handle and identifies the destination(s) of the PDU.\n
 *           The call is routed to a lower IF module using the appropriate I-PDU handle of the destination layer.
 * \param    id                ID of the J1939Rm I-PDU to be transmitted
 ...
 *                             or the J1939RmTxPduId is not valid\n
 *                             or the J1939RmTxPduId is not forwarded in this identity\n
 ...
 *           PduR_J1939RmTransmit calls for the same J1939RmTxPduId.
 * \trace    DSGN-PduR_TP_Forwarding
 * \trace    SPEC-666, SPEC-679, SPEC-686, SPEC-1827, SPEC-1096, SPEC-2020085, SPEC-38411
 * \note     The function is called by J1939Rm.
 *********************************************************************************************************************/
FUNC(Std_ReturnType, PDUR_CODE) PduR_J1939RmTransmit(PduIdType id, P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info);
