 ...
 *
 *   Description:  C-Code implementation template for BSW Module <J1939Tp>
 *********************************************************************************************************************/
...
/**********************************************************************************************************************
 *
 * Schedulable Entity Name: J1939Tp_MainFunction
 *
 *********************************************************************************************************************/

FUNC(void, J1939TP_CODE) J1939Tp_MainFunction(void) /* PRQA S 0850 */ /* MD_MSR_19.8 */
{
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           << Start of runnable implementation >>             DO NOT CHANGE THIS COMMENT!
 * Symbol: J1939Tp_MainFunction
 *********************************************************************************************************************/

  TSC_J1939Tp_SchM_Enter_J1939Tp_RxNSduLock();
  TSC_J1939Tp_SchM_Exit_J1939Tp_RxNSduLock();
  TSC_J1939Tp_SchM_Enter_J1939Tp_TxNPduLock();
  TSC_J1939Tp_SchM_Exit_J1939Tp_TxNPduLock();
  TSC_J1939Tp_SchM_Enter_J1939Tp_TxNSduLock();
  TSC_J1939Tp_SchM_Exit_J1939Tp_TxNSduLock();
